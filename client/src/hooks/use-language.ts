...
const translationsFull = {
  ar: {
    ...
    brandStoryDesc: "في آن بيوتي، نؤمن أن الجمال ليس مجرد مكياج، بل هو تعبير عن الأنوثة والثقة. نحرص على تقديم أجود منتجات التجميل التي تُبرز جمالك الطبيعي وتعكس شخصيتك الفريدة.",
  ...
  en: {
    ...
    brandStoryDesc: "At Anne Beauty, we believe beauty is more than just makeup; it's an expression of femininity and confidence. We offer the finest beauty products that enhance your natural glow and reflect your unique personality.",
