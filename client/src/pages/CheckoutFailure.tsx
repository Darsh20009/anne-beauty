  ...
  return (
    <Layout>
      <div className="min-h-[60vh] flex flex-col items-center justify-center p-4 text-center">
        ...
        <h1 className="text-3xl font-black mb-4" data-testid="text-failure-title">عذراً، فشلت عملية الدفع</h1>
        <div className="bg-red-50 border border-red-100 p-4 rounded-lg mb-8 max-w-md flex items-center gap-3 text-red-800">
          <AlertCircle className="w-5 h-5 flex-shrink-0" />
          <p className="text-sm text-right" data-testid="text-failure-reason">
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <Link href="/checkout">
            <Button size="lg" className="min-w-[200px]" data-testid="button-retry">
              المحاولة مرة أخرى
            </Button>
          </Link>
          <Link href="/cart">
            <Button variant="outline" size="lg" className="min-w-[200px]" data-testid="button-back-to-cart">
